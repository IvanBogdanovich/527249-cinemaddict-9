const createPopupDescFilm = (data, hidden) => {
  return `<section class="film-details" style="display: ${hidden}">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                <span class="film-details__genre">${data.genre}</span>
                <span class="film-details__genre">${data.genre}</span>
    ...
    <div class="form-details__bottom-container">
      <section class="film-details__comments-wrap">
        <h3 class="film-details__comments-title">Comments <span class="film-details__comments-count">${data.amountComments}</span></h3>
          ...
          <li class="film-details__comment">
            ...
            <div>
              ...
              <p class="film-details__comment-info">
                ...
                <span class="film-details__comment-day">${item.dateDays} days ago</span>
